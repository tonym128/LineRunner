...
static FIXPOINT xVec2(FIXPOINT speed, FIXPOINT radians) {
// Precision wasn't good enough
//  return FIXP_MULT(speed, FIXP_SIN(radians));
  return (FIXPOINT)(speed * sin(FIXP_TO_FLOAT(radians)));
}

static FIXPOINT yVec2(FIXPOINT speed, FIXPOINT radians) {
// Precision wasn't good enough
  //return FIXP_MULT(speed * -1, FIXPOINT_COS(radians));
  return (FIXPOINT)(speed * -1 * cos(FIXP_TO_FLOAT(radians)));
}
